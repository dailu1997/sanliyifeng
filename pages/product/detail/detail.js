var t = "https://www.monainet.com", a = getApp();
...
Page({
    ...
    onLoad: function(e) {
        var n = this;
        wx.request({
            url: t + "/wechatapi/company.product/watchDetail.html",
            data: {
                id: e.id,
                token: wx.getStorageSync("token")
            },
            success: function(e) {
                var i = e.data.description, o = a.towxml.toJson(i, "markdown"), l = t + e.data.image;
                o.theme = "light", n.setData({
                    article: o,
                    title: e.data.name,
                    img: l
                });
    ...
    getConfig: function() {
        var a = this;
        wx.request({
            url: t + "/wechatapi/company.cmenu/getConfig.html",
            data: {
                token: wx.getStorageSync("token")
            },
            header: {
